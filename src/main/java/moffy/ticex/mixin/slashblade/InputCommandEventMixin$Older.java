...
@Pseudo
@Mixin(targets = "mods.flammpfeil.slashblade.event.InputCommandEvent", remap = false)
public abstract class InputCommandEventMixin$Older implements IInputCommandEvent {
    @Shadow
