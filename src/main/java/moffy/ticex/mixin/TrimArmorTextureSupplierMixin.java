...
public abstract class TrimArmorTextureSupplierMixin {
    ...
    private ArmorTextureSupplier.ArmorTexture insertTexture(ResourceLocation root, TrimMaterial material, Operation<ArmorTextureSupplier.ArmorTexture> original) {
        ...
        ShaderProvider.Armor shaderProvider = TicEXRenders.ARMOR_SHADERS.getShaderProvider(TicEXMaterials.INFINITY);

        int color = -1;
        Optional<MaterialRenderInfo> infoOptional = MaterialRenderInfoLoader.INSTANCE.getRenderInfo(TicEXMaterials.INFINITY);
