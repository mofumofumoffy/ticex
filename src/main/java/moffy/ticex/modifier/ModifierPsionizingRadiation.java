...
public class ModifierPsionizingRadiation
    ...
    public static ResourceLocation AUTO_CASTING_LOC = ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "autocasting");
    public static ResourceLocation SOCKETS_LOC = ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "cad_sockets");
    public static final ResourceLocation TIMES_CAST_LOC = ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "timescast");
