...
public abstract class ToolShaderMap<S, T extends ShaderProvider<S>> {
    ...
    public abstract void addShader(
        MaterialVariantId materialVariantId,
        Consumer<S> renderConsumerOverlay,
        Consumer<S> renderConsumerUnderlay
    );
    ...
    public static class Tool extends ToolShaderMap<RenderQuadArgsWrapper, ShaderProvider.Tool> {
        ...
        public void addShader(
            MaterialVariantId materialVariantId,
            Consumer<RenderQuadArgsWrapper> renderConsumerOverlay
        ) {
        ...
        public void addShader(
            MaterialVariantId materialVariantId,
            Consumer<RenderQuadArgsWrapper> renderConsumerOverlay,
            Consumer<RenderQuadArgsWrapper> renderConsumerUnderlay
        ) {
            this.shaderMap.put(
                    new PartPredicate(materialVariantId),
                    new ShaderProvider.Tool(renderConsumerOverlay, renderConsumerUnderlay)
                );
        }
    ...
    public static class Armor extends ToolShaderMap<ArmorRenderArgsWrapper, ShaderProvider.Armor> {
        ...
        public void addShader(
            MaterialVariantId materialVariantId,
            Consumer<ArmorRenderArgsWrapper> renderConsumerOverlay
        ) {
        ...
        public void addShader(
            MaterialVariantId materialVariantId,
            Consumer<ArmorRenderArgsWrapper> renderConsumerOverlay,
            Consumer<ArmorRenderArgsWrapper> renderConsumerUnderlay
        ) {
            this.shaderMap.put(
                    new PartPredicate(materialVariantId),
                    new ShaderProvider.Armor(renderConsumerOverlay, renderConsumerUnderlay)
                );
        }
