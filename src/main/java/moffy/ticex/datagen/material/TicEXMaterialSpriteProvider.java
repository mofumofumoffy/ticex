    ...
    protected void addAllMaterials() {
        ...
        buildMaterial(TicEXMaterials.CRYSTAL_MATRIX).meleeHarvest().ranged()
                .fallbacks("metal").transformer(
                        GreyToSpriteTransformer.builder()
                                .addARGB(0, 0xFF000000)
                                .addTexture(63, ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "material/crystal_matrix_outline_dark"))
                                .addTexture(102, ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "material/crystal_matrix_outline"))
        ...
        buildMaterial(TicEXMaterials.INFINITY).meleeHarvest().ranged().armor()
                .fallbacks("metal").transformer(
                        AnimatedGreyToSpriteTransformer.builder()
                                .addARGB(0, 0xFF000000)
                                .addTexture(63, ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "material/infinity_dark"))
                                .addTexture(178, ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "material/infinity_medium"))
                                .addTexture(255, ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "material/infinity_light"))
                                .animated(ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "material/infinity_medium"), 9)
        );
        buildMaterial(TicEXMaterials.NEUTRON).armor()
                .fallbacks("metal").transformer(
                        GreyToSpriteTransformer.builder()
                                .addARGB(0, 0xFF000000)
                                .addTexture(63, ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "material/neutron_outline_dark"))
                                .addTexture(102, ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "material/neutron_outline"))
