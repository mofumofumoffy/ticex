...
public class MaterialStatsProvider extends AbstractMaterialStatsDataProvider {
    ...
    private void addArmor() {
        addArmorShieldStats(TicEXMaterials.INFINITY,
            PlatingMaterialStats.builder().durabilityFactor(9999.0f).armor(8.14f, 17.44f, 30f, 9.3f).toughness(15f).knockbackResistance(0.25f),
            StatlessMaterialStats.MAILLE
        );
        addArmorShieldStats(TicEXMaterials.NEUTRON,
            PlatingMaterialStats.builder().durabilityFactor(1111.0f).armor(3.36f, 7.2f, 9f, 3.84f).toughness(15f).knockbackResistance(100f),
            StatlessMaterialStats.MAILLE
        );
    }
