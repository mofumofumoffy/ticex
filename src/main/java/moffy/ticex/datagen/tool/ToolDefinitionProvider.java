...
public class ToolDefinitionProvider  extends AbstractToolDefinitionDataProvider {
    ...
    protected void addToolDefinitions() {
        ...
        if(TicEXRegistry.GUN_DEFINITION != null){
            define(TicEXRegistry.GUN_DEFINITION).module(PartStatsModule.parts()
                .part(largePlate)
                .part(toughHandle, 0.5f)
                .part(TicEXRegistry.CATALYST_KINETIC_GUN).build())
        ...
        if(TicEXRegistry.SINGULAR_GEM_DEFINITION != null){
            ...
            .module(ArmorItem.Type.CHESTPLATE, ToolTraitsModule.builder().trait(TicEXRegistry.INFERNAL_MODIFIER).build())
            .module(ArmorItem.Type.LEGGINGS, ToolTraitsModule.builder().trait(TicEXRegistry.GRAVITY_MODIFIER).build())
            .module(ArmorItem.Type.BOOTS, ToolTraitsModule.builder().trait(TicEXRegistry.HURRICANE_MODIFIER).build());
        }
    }
