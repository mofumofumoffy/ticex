...
public class MaterialTraitsProvider extends AbstractMaterialTraitDataProvider {
    ...
    protected void addMaterialTraits() {
        ...
        addTraits(TicEXMaterials.DRACONIUM, MELEE_HARVEST, TicEXRegistry.SOUL_RENDING_MODIFIER, TinkerModifiers.lacerating);
        addTraits(TicEXMaterials.WYVERN, MELEE_HARVEST, TicEXRegistry.SOUL_RENDING_MODIFIER, TinkerModifiers.lacerating);
        addTraits(TicEXMaterials.DRACONIC, MELEE_HARVEST, new ModifierEntry(TicEXRegistry.SOUL_RENDING_MODIFIER, 2), new ModifierEntry(TinkerModifiers.lacerating, 2));
        addTraits(TicEXMaterials.CHAOTIC, MELEE_HARVEST, new ModifierEntry(TicEXRegistry.SOUL_RENDING_MODIFIER, 3), new ModifierEntry(TinkerModifiers.lacerating, 3));

        addDefaultTraits(TicEXMaterials.INFINITY, TicEXRegistry.OMNIPOTEMCE_MODIFIER, TicEXRegistry.COSMIC_LUCK_MODIFIER, TicEXRegistry.COSMIC_UNBREAKABLE_MODIFIER, TicEXRegistry.BEDROCK_BREAKER_MODIFIER);
        addDefaultTraits(TicEXMaterials.CRYSTAL_MATRIX, TicEXRegistry.AFTERSHOCK_MODIFIER, TinkerModifiers.insatiable);
        addTraits(TicEXMaterials.INFINITY, ARMOR, TicEXRegistry.TRANSCENDENTAL_MODIFIER, TicEXRegistry.COSMIC_UNBREAKABLE_MODIFIER);
