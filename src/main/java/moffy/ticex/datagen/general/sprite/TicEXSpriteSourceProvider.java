...
public class TicEXSpriteSourceProvider extends SpriteSourceProvider {
    ...
    protected void addSources() {
        ...
        ResourceLocation trimPalette = ResourceLocation.fromNamespaceAndPath(TicEX.MODID, paletteFolder + "trim_palette");
        ...
        atlas(ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "armor_trims"))
                .addSource(new PalettedPermutations(
                        Arrays.stream(TRIMS).flatMap(name -> Stream.of(
                                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, trimFolder + name),
                                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, trimFolder + name + "_leggings"))
                        ).toList(),
                        trimPalette, materialMap)
                )
