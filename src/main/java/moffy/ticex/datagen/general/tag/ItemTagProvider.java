...
public class ItemTagProvider extends ItemTagsProvider {
    ...
    private void addCommon() {
        addCores(
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "reconstruction_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "flickering_reconstruction_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "celestial_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "radiation_shelding_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "draconium_evolved_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "wyvern_evolved_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "draconic_evolved_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "chaotic_evolved_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "inject_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "konpaku_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "koshirae_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "lamellar_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "overload_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "override_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "incomparable_core"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "cardboard_core")
        );
        ...
        addOptional(TicEXTags.Items.ETHERIC_INGOT, ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "etheric_ingot"));
        ...
        addOptional(TicEXTags.Items.ETHERIC_BLOCK, ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "etheric_block"));
        ...
        //catalyst_tools
        addCatalysts(
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "catalyst_slashblade"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "catalyst_kinetic_gun"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "catalyst_irons_spellbook"),
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "catalyst_meka_tool")
        );

        //catalyst_armors
        for (ArmorItem.Type type : ArmorItem.Type.values()) {
            addCatalysts(
                    ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "catalyst_mekasuit").withSuffix("_" + type.getName()),
                    ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "catalyst_gem").withSuffix("_" + type.getName())
            );
        }

        addOptional(TinkerTags.Items.TOOL_PARTS, ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "slashblade_blade"));
        addOptional(TinkerTags.Items.TOOL_PARTS, ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "slashblade_saya"));
    ...
    private void addTools() {
        //tools
        addToolTags(
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "reforged_slashblade"),
        ...
        addToolTags(
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "blitz_gun"),
        ...
        addToolTags(
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "revival_spellbook_irons"),
        ...
        addToolTags(
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "meka_tool"),
        ...
        addArmorTags(
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "mekaplate"),
        ...
        addArmorTags(
                ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "singular_gem"),
