...
public class BlockTagProvider extends BlockTagsProvider {
    ...
    private void addCommon() {
        ...
        addMetalTags(TicEXTags.Blocks.ETHERIC, ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "etheric_block"), true);

        tag(TicEXTags.Blocks.FLUID_TRANSMUTER_TANK)
                .addOptionalTag(TinkerTags.Blocks.ALLOYER_TANKS);

        addPickaxeBlock(BlockTags.NEEDS_IRON_TOOL, ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "etheric_block"));

        addPickaxeBlock(BlockTags.NEEDS_STONE_TOOL,
            ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "seared_rf_furnace"),
            ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "scorched_rf_furnace"),
            ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "creative_seared_rf_furnace"),
            ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "creative_scorched_rf_furnace")
        );
    }
