    ...
    protected void addLayouts() {
        if (TicEXRegistry.REVIVAL_SPELLBOOK_IRONS != null) {
            defineModifiable((IModifiableDisplay) TicEXRegistry.REVIVAL_SPELLBOOK_IRONS.get())
                    .icon(new Pattern(ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "revival_spellbook")))
                    ...
                    .addInputSlot(new Pattern(ResourceLocation.fromNamespaceAndPath(TicEX.MODID, "catalyst")), "item.ticex.catalyst_irons_spellbook", 33, 44,
